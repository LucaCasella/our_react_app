export const API_AIRPORTS = "https://world-airports-directory.p.rapidapi.com/v1/airports/dub?page=1&limit=10&sortBy=AirportName%3Aasc";
export const AIRPORT_HOME = "HOME";
